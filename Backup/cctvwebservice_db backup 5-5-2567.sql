...
--
-- Host: 127.0.0.1
-- Generation Time: May 05, 2024 at 06:42 PM
...
CREATE TABLE `user` (
  ...
  `img_url` tinyint(1) NOT NULL DEFAULT 0
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_general_ci;
...
INSERT INTO `user` (`user_id`, `name_lastname`, `phone`, `email`, `address`, `img_url`) VALUES
(1, 'Abdullah Chemae', '0826537095', 'vernerlive.090@gmail.com', 'ยะลา ประเทศไทย', 0),
(2, 'UserTest Admin', '9876543210', 'testemailadmin@gmail.com', 'สงขลา ประเทศไทย', 0),
(3, 'ลูกค้าทดลอง คนที่1', '0123456789', 'testemail123@gmail.com', 'ปัตตานี ประเทศไทย', 0),
(4, 'ลูกค้าทดลอง คนที่2', '9876543210', 'testemail123@gmail.com', 'ปัตตานี ประเทศไทย', 0),
(5, 'ลูกค้าทดลอง คนที่3', '0123456789', 'testemail123@gmail.com', 'ปัตตานี ประเทศไทย', 0),
(6, 'ลูกค้าทดลอง', '132456', 'test@gmail.com', 'ประเทศไทย', 0);
...
--
ALTER TABLE `worksite`
  MODIFY `worksite_id` int(10) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=6;
